...
logger.add(log_path_all, rotation="12:00", retention="5 days", enqueue=True,serialize=True)
logger.add(log_path_error, rotation="12:00", retention="5 days", enqueue=True,level='ERROR',serialize=True) # 日志等级分割
